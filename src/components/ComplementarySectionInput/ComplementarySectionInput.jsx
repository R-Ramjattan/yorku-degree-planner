...
import './ComplementarySectionInput.css';

const COURSE_REGEX = /^[A-Z]{2,4}\s\d{4}$/;

export default function ComplementarySectionInput({ value = [], onChange }) {
  ...
  return (
    <div className="complementary-container">
      <label className="label-with-icon">
        Complementary Courses
        <span className="info-icon" tabIndex="0">
          ℹ️
          <span className="tooltip">
            Enter codes like “ECON 1000”<br/>
